<x-admin :title="'Tournament Details'">
                ...
                <div class="inverted-radius my-5 relative">
                    <div class="inverted-radius-content">
                        ...
                        <div class="frame-wrapper">
                            <p>This is how the tournament is displayed on the website. Please make sure all the information is correct. if you have any issues with the tournament you can perform the following commands:
                            </p>
                            <div class="link-grid-item mb-4">
                                <div>
                                    <div class="text-sm">Add to Website</div>
                                    <div class="text-2xl font-semibold">Edit Tournament</div>
                                    <a href="{{ route('admin.tournaments.edit', $tournament->id) }}"><button class="grid-link-btn ">Update Tournament <span><i class="ml-10 fa-solid fa-pen-to-square text-sm"></i></span></button></a>
                                </div>
                            ...
                            <div class="link-grid-item">
                                <div>
                                    <div class="text-sm">Add to Website</div>
                                    <div class="text-2xl font-semibold">Delete Tournament</div>
