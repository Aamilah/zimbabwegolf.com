    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="my-4">
            ...
            <select id="department" name="department" class="form-input" required>
                ...
                <option value="player" {{ old('department') == 'player' ? 'selected' : '' }}>Player</option>
                <option value="staff" {{ old('department') == 'staff' ? 'selected' : '' }}>Staff</option>
                <option value="tournament_official" {{ old('department') == 'tournament_official' ? 'selected' : '' }}>Tournament Official</option>
            </select>
