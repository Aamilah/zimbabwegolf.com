    ...
    <aside
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <a href="{{ route('admin.admin-dashboard') }}"
            class="admin-nav-link {{ Route::is('admin.admin-dashboard') ? 'active' : '' }}"
          ...
          <a href="{{ route('admin.players.index') }}"
            class="admin-nav-link {{ Route::is('admin.players.index') ? 'active' : '' }}"
                @click="sidebarOpen = false">
          ...
          <a href="{{ route('admin.blog.index') }}"
            class="admin-nav-link {{ Route::is('admin.blog.index') ? 'active' : '' }}"
              @click="sidebarOpen = false">
